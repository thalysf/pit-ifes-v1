...
@RestController
@RequestMapping("api/respostas/extensao")
@AllArgsConstructor
@Validated
public class RespostaExtensaoController {
    ...
    /**
     * Retorna as respostas das atividades de extensão do professor
     *
     * @param idPit
     * @return
     */
    @GetMapping()
    public List<RespostaAtividade> listarRespostaAtividadesExtensao(@RequestParam UUID idPit) {
        return respostaService.listarRespostaAtividadesExtensao(idPit);
    }
     ...
     * Filtrar todas as atividades pelo tipo_atividade ATIVIDADE_EXTENSAO
    ...
    public List<Atividade> listarAtividadesProfessorParticipa(@RequestParam("idUsuario") UUID idUsuario, @RequestParam("idPit") UUID idPit) {
        ...
        return respostaService.listarAtividadesExtensaoProfessorParticipa(pit, idUsuario);
    }
