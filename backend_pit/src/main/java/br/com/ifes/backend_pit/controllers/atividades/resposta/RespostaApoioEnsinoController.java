...
@RestController
@RequestMapping("api/respostas/apoioEnsino")
@AllArgsConstructor
@Validated
public class RespostaApoioEnsinoController {
    ...
    /**
     * Retorna as respostas das atividades de apoio ao ensino do professor
     *
     * @param idPit
     * @return
     */
    @GetMapping()
    public List<RespostaAtividade> listarRespostaAtividadesApoioEnsino(@RequestParam UUID idPit) {
        return respostaService.listarRespostaAtividadesApoioEnsino(idPit);
    }
     ...
     * Filtrar todas as atividades pelo tipo_atividade ATIVIDADE_APOIO_ENSINO
    ...
    public List<Atividade> listarAtividadesProfessorParticipa(@RequestParam("idUsuario") UUID idUsuario, @RequestParam("idPit") UUID idPit) {
        ...
        return respostaService.listarAtividadesApoioEnsinoProfessorParticipa(pit, idUsuario);
    }
